...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/core/orders/orders/">订单列表</a></li>
		<shiro:hasPermission name="core:orders:orders:edit"><li><a href="${ctx}/core/orders/orders/form">订单添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="orders">
			<tr>
				...
				<%--<shiro:hasPermission name="core:orders:orders:edit"><td>
    				<a href="${ctx}/core/orders/orders/form?id=${orders.id}">修改</a>
					<a href="${ctx}/core/orders/orders/delete?id=${orders.id}" onclick="return confirmx('确认要删除该订单吗？', this.href)">删除</a>
