...
public class UserController extends BaseController {
	...
	public String net(HttpServletRequest request, HttpServletResponse response, Model model,String loginName) {
        ...
        Member mba = null;
        Member mbb = null;
        String parentName = user.getLoginName();
        String parentName2 = user.getLoginName();
        //m1
        ...
        for (Member m:memberList) {
            if(m != null){
                ...
                if(contact.equals(parentName) && "A".equals(m.getArea())){
                    ma = m;
                    parentName = m.getLoginName();
                    break;
                }
            }
        }
        //mb
        if("0".equals(m1.getMemberlevel())){
            mb = null;
        }else{
            for (Member m:memberList) {
                if(m != null){
                    String contact = m.getContact();
                    if(contact.equals(user.getLoginName()) && "B".equals(m.getArea())){
                        mb = m;
                        parentName2 = m.getLoginName();
                        break;
                    }
                }
            }
        ...
        if(ma==null || ma.getMemberlevel() == null || "0".equals(ma.getMemberlevel())){
            ...
            for (Member m:memberList) {
                if(m != null){
                    String contact = m.getContact();
                    if(contact.equals(parentName) && "B".equals(m.getArea())){
                        mab = m;
                        break;
                    }
                }
        ...
        if(mb == null){
            ...
            for (Member m:memberList) {
                if(m != null){
                    String contact = m.getContact();
                    if(contact.equals(parentName2) && "A".equals(m.getArea())){
                        mba = m;
                        break;
                    }
                }
            ...
            if(mb==null || mb.getMemberlevel() == null || "0".equals(mb.getMemberlevel())){
                ...
                for (Member m:memberList) {
                    if(m != null){
                        String contact = m.getContact();
                        if(contact.equals(parentName2) && "B".equals(m.getArea())){
                            mbb = m;
                            break;
                        }
                    }
